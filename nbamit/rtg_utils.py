...
def calc_new_volatility(vol,phi,v,delta,tao, sigma = 0.000001):
    ...
    while abs(B - A) > sigma:
        ...
        f_B=f_C
    return math.e ** (A/2)
# update the rating deviation of a player
...
# convert the rating to the original scale
def convert_to_original_scale(mu):
    return mu * 173.7178 + 1500
# convert the rating deviation to the original scale
...
# op_rtg = 1400
# op_rd = 30
# new_rating, new_rd = calc_new_rating(rating, rd,vol, s, op_rtg, op_rd)
# print(new_rating, new_rd)
